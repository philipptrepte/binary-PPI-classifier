...
Please see the [Vignette](https://philipptrepte.github.io/binary-PPI-classifier/articles/introduction.html) for a detailed description or access from within R using `vignette("introduction", package = "binaryPPIclassifier")`. Make sure that when installing the package you set `build_vignettes = TRUE`.
